...
.L02 ;  set kernel_options playercolors player1colors pfcolors
...
.L07 ;  player0color:
	...
	LDX #<playercolorL07_0
	STX player0color
	LDA #>playercolorL07_0
	STA player0color+1
.
 ; 
...
.L011 ;  drawscreen
 ...
 jsr drawscreen
.L012 ;  if joy0right then x = x + 1  :  REFP0  =  0
...
.condpart0
	...
	STA REFP0
.skipL012
.L013 ;  if joy0left then x = x - 1  :  REFP0  =  8
