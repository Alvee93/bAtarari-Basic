...
.skipL07
.L08 ;  if f  >  10  &&  f  <  20 then gosub frame2
...
.skip2then
.skipL08
.L09 ;  if f  >  20  &&  f  <  30 then gosub frame3
...
.L010 ;  drawscreen
 ...
 jsr drawscreen
.L011 ;  player1x = x  :  player1y = y

	LDA x
	STA player1x
	LDA y
	STA player1y
.L012 ;  if joy0right then x = x + 1  :  REFP1  =  0
...
.condpart6
	...
	STA REFP1
.skipL012
.L013 ;  if joy0left then x = x - 1  :  REFP1  =  8
